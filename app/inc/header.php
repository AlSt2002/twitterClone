...
<?php 
    ...
    $user = $user->find_id($session->userId);
   
?>
 
  <body class="d-flex">
    <!-- Navbar part -->
    <nav class="navbar d-none d-md-flex flex-column border-end" id="navbar">
      <div
        class="container align-content-start flex-column pt-2"
        id="nav-container"
      >
        <a class="navbar-brand align-self-start mb-4" href="index.php" id="navbar-logo">
          <svg
        ...
        <button type="button" class="btn btn-primary custom-button justify-content-start w-75 mt-2">Post</button>
      </div>
      
      <button class="profile d-flex align-self-start  pt-1 pb-1 ps-1 pe-2">
        <div class="circle">
          <div class="background-profile">
              <img src="img/user.png" class="w-100 h-100"  alt="">
          </div>
        </div>
        <div class="username d-flex flex-column fs-6 ps-2">
          <p id="name" class="mt-0 mb-0 fw-bold align-self-start">
              <?php echo $user->getFirstname(); ?>
          </p>
          <p id="u_name" class="mt-0 mb-0 align-self-start" style="color: #96a0a8;">
              @<?php echo $user->getUsername(); ?>
          </p>
      </div>
      <div id="more" class="align-self-center ms-5">
